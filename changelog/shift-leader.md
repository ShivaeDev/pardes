...
## [0.2.0] - 2026-05-29
### Changed
- New `GOTCHAS.md` with 14 durable orchestration lessons covering false green builds, writer isolation, disjoint partitioning, brief-vs-code conflicts, worktree hygiene, and more.
